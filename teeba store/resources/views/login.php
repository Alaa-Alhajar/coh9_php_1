...
<head>
    ...
    <title>welcome to teeba haiber_market</title>
    ...
    <style media="screen">
        ...
        *:after {
        ...
        body {
            background-image: url(../resources/img/almari.jpeg.jpg);
...
<div class="background">
    ...
    <h1> Login Page</h1>
        ...
        <div >
            ...
            <input type="text" placeholder="Email or phone" id="admin-username" name="username">
