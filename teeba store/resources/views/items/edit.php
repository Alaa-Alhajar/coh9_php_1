...
<form action="/items/update" method="POST" class="w-50">
    ...
    <div class="form-floating">
        ...
        <textarea class="form-control" placeholder="Your price.." id="post-content" style="height: 100px" name="price"><?= $data->item->price ?></textarea>
    ...
    <div class="form-floating">
        ...
        <textarea class="form-control" placeholder="Your quantity.." id="post-quantity" style="height: 100px" name="quantity"><?= $data->item->quantity ?></textarea>
